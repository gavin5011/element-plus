<template>
  <div class="demo-page" data-testid="demo-root">
      ...
      <el-dropdown data-testid="dropdown-basic">
        ...
        <template #dropdown>
          <el-dropdown-menu data-testid="dropdown-menu">
            ...
            <el-dropdown-item data-testid="item-delete" divided>Delete</el-dropdown-item>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
    </section>
    ...
    <section data-testid="scenario-interaction">
      ...
      <el-dropdown trigger="click" data-testid="dropdown-click" @command="handleCommand">
        <el-button data-testid="dropdown-click-trigger">
          Selected: <span data-testid="dropdown-value">{{ selected }}</span>
        </el-button>
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item command="Small" data-testid="opt-small">Small</el-dropdown-item>
            <el-dropdown-item command="Medium" data-testid="opt-medium">Medium</el-dropdown-item>
            <el-dropdown-item command="Large" data-testid="opt-large">Large</el-dropdown-item>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
    </section>
    ...
    <section data-testid="scenario-state">
      ...
      <el-button data-testid="dropdown-toggle-disabled" @click="dropdownDisabled = !dropdownDisabled">
        Toggle disabled: <span data-testid="state-indicator">{{ dropdownDisabled ? 'disabled' : 'enabled' }}</span>
      </el-button>
      <el-dropdown :disabled="dropdownDisabled" data-testid="dropdown-state-target">
...
function handleCommand(cmd: string) { selected.value = cmd }
