<template>
  <div class="demo-page" data-testid="demo-root">
    ...
    <section data-testid="scenario-state">
      ...
      <el-button data-testid="radio-toggle-button" @click="buttonMode = !buttonMode">
        Toggle mode: <span data-testid="state-indicator">{{ buttonMode ? 'button' : 'default' }}</span>
      </el-button>
      <el-radio-group v-if="!buttonMode" data-testid="radio-state-target" v-model="stateValue">
        <el-radio value="Small" label="Small">Small</el-radio>
        <el-radio value="Medium" label="Medium">Medium</el-radio>
        <el-radio value="Large" label="Large">Large</el-radio>
      </el-radio-group>
      <el-radio-group v-else data-testid="radio-state-target" v-model="stateValue">
